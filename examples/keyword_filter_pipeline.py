...
class StoreText(luigi.Task):
    ...
    def run(self):
        print("Beginning StoreText() task ...")
...
class StoreLabel(luigi.Task):
    ...
    def _requires(self):
        return flatten([StoreText(self.db, self.collection), super(StoreLabel, self)._requires()])
